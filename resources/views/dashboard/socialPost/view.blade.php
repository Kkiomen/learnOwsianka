                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <div class="w-full">
                        ...
                        <form method="POST" action="{{ route('saveEvent') }}">
                            ...
                            <x-bladewind.input label="Short description" name="short_description" value="{{ $blog->short_description }}"/>
                            ...
                            <div class="border border-1 border-gray-500 rounded p-5 my-4">
                                <h3 class="text-sm leading-7 text-gray-900 sm:truncate sm:text-sm sm:tracking-tight">Content</h3>

                                @foreach($blog->contents as $content)
                                    <form method="POST" action="{{ route('socialPost.updateBlogContent', ['contentId' => $content->id ]) }}" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="lg:flex lg:items-center lg:justify-between">
                                                ...
                                                @endif
                                                  ...
                                                  <button type="submit"
                                                    ...
                                                    <span class="sm:ml-3">
                                                    <a href="{{ route('socialPost.removeBlogContent', ['contentId' => $content->id]) }}"  onclick="return confirm('Are you sure you want to delete this item?');">
                                                        <button type="button"
...
{{--                                                        url="https://bladewindui.com/images/404.svg"--}}
                                                        ...
                                                        @if($content->image_url !== null)
                                                            <img src="{{ asset('storage/uploads/'. $content->image_url) }}" />
                                                        @endif
...
{{--                                                        <x-bladewind.input label="Image" name="image_url" value="{{ $content->image_url }}"/>--}}
                                                        <x-bladewind.input label="Alt" name="image_alt" value="{{ $content->image_alt }}"/>
                                                        @break

                                                    @case('text_with_header')
                                                        <x-bladewind.input label="Header" name="header" value="{{ $content->header }}"/>
                                                        <textarea name="content" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-3">{{ $content->content }}</textarea>
                                            ...
                                            <div class="flex">
                                                <a href="{{ route('socialPost.generateArticleAddContent', ['blogId' => $blog->id, 'type' => 'image', 'contentId' => $content->id ]) }}" class="w-1/2 px-2">
                                                    <div class="border border-b border-gray-300 border-dashed my-5 mx-auto text-center hover:cursor-pointer hover:border-solid hover:border-black">
                                                        <i class="fa-regular fa-image" style="color: #a8acb0"></i>
                                                    </div>
                                                </a>
                                                <a href="{{ route('socialPost.generateArticleAddContent', ['blogId' => $blog->id, 'type' => 'text', 'contentId' => $content->id ]) }}" class="w-1/2 px-2">
                                                    <div class="border border-b border-gray-300 border-dashed my-5 mx-auto text-center hover:cursor-pointer hover:border-solid hover:border-black">

<x-app-layout>
                                            ...
                                            @switch($content->type)
                                                ...
                                                @case('image')
                                                    ...
                                                    @if($content->image_url !== null)
                                                        <img
                                                            src="{{ asset('storage/image-uploads/'. $content->image_url) }}"/>
                                                    @endif
                                                    <div class="col-span-full">
                                                        <div
    ...
    <div class="max-w-7xl mx-auto px-5">
        <a href="{{ route('generateForSocialPost.generate', ['socialPostId' => $socialPost->id]) }}">
            <button type="button"
                    class="inline-flex items-center rounded-md bg-white w-full px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                <i class="fa-solid fa-gear mr-2"></i>
                ...
                @foreach($posts as $post)
                    <div class="bg-white p-3 pb-10 rounded">
                        <div
                            ...
                            @if($post->image !== null)
                                <img src="{{ asset('storage/image-uploads/'. $post->image) }}" class="h-full w-full object-cover object-center group-hover:opacity-75"/>
                            @endif
                        </div>

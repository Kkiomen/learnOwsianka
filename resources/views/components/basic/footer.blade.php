        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-3 text-center text-md-start sm-margin-20px-bottom">
                    <a href="{{ route('index') }}" class="footer-logo navbar-brand-text text-white">oatllo</a>
                </div>
                <div class="col-12 col-md-6 text-center last-paragraph-no-margin sm-margin-20px-bottom">
                    <p>&copy; {{ date('Y') }} Oatllo - Powered by Jakub Owsianka, Layout:  <a href="https://www.themezaa.com/" target="_blank">ThemeZaa</a></p>
                </div>
